...
Antigravity/agy, Claude, Grok, Kimi) instead of spawning a channel worker, use
the Trellis-bundled `codeagent-wrapper`. Channel spawns use it internally; the
notes below are for calling it yourself.
